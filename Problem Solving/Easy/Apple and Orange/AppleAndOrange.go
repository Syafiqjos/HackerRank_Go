...
func incrementSomething(accumulator *int32, s, t, pos int32) {
	if pos >= s && pos <= t {
		(*accumulator)++
	}
}
...
func countApplesAndOranges(s int32, t int32, a int32, b int32, apples []int32, oranges []int32) {
	...
	var orangeCount, appleCount int32

	for _, d := range apples {
		incrementSomething(&appleCount, s, t, a+d)
	}

	for _, d := range oranges {
		incrementSomething(&orangeCount, s, t, b+d)
	}
